...
export const SearchBar = ({ onSearch, className }: SearchBarProps) => {
  ...
  return (
    <div className="flex gap-2 max-w-[150%] mx-auto items-center">
      <form onSubmit={handleSubmit} className={`flex gap-2 flex-1 ${className || ''}`}>
        ...
        <Button type="submit" className="hover:bg-purple-600 hover:text-white transition-colors h-12 px-6">
      ...
      <Button 
        ...
        className="hover:bg-purple-100 dark:hover:bg-purple-900 transition-colors h-12"
      >
